...
/**
 * The SubscriberRegistrationUI class handles the user interface for registering a new subscriber.
 * <p>
 * This screen is typically accessed by a Representative or Manager. It collects user details 
 * (Name, Email, Phone, Username), validates the input, and sends a registration request 
 * to the server via the {@link RepresentativeController}.
 */
public class SubscriberRegistrationUI {
    ...
    /**
     * Constructs the SubscriberRegistrationUI instance.
     *
     * @param mainLayout The main layout container where the form will be rendered.
     * @param mainUI     The main application instance.
     * @param onBack     A Runnable callback to execute when the user cancels or completes registration.
     */
    ...
    /**
     * Starts the registration interface by building and displaying the form.
     */
    public void start() {
    ...
    /**
     * Constructs the visual registration form with fields for personal information
     * and buttons to submit or cancel.
     */
    ...
    /**
     * Gathers the input data, constructs a new User object, and sends it to the server
     * via the RepresentativeController.
     * <p>
     * Note: The User ID is set to 0 and the Subscriber Number is null initially, 
     * as these are generated by the database/server upon successful insertion.
     *
    ...
    /**
     * Placeholder method for generating a digital card (QR code) for the subscriber.
     * Currently logs the action to the console.
     *
     * @param subscriberID The ID of the newly registered subscriber.
     */
